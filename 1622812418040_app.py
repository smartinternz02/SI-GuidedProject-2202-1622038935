...
@app.route('/')
def home():
    return render_template('D://bhavya//index.html')

@app.route('/m_predict')
def predict():
    return render_template('D://bhavya//Manual_predict.html')
...
def y_predict():
    ...
    return render_template('D://bhavya//Manual_predict.html', prediction_text=pred)

@app.route('/s_predict')
def spredict():
    return render_template('D://bhavya//Sensor_predict.html')
...
def sy_predict():
    ...
    if(pred == 0):
        ...
        pred = "Maintenance Required!! Expected a failure within 30 days."
    return render_template('D://bhavya//Sensor_predict.html', prediction_text=pred,data=inp1)
